...
class Dictionary:
    ...
    def serve(cls, req):
        ...
        jp.Div(a=div, text="""
        Get the definition of any English word instantly as you type 
        """, classes='text-lg')
        input_div = jp.Div(a=div, classes='grid grid-cols-2')

        output_div = jp.Div(a=div, classes='m-2 p-2 text-lg border-2 h-40')

        input_box = jp.Input(a=input_div, placeholder='Typ in a word here...', outputdiv=output_div,
                             classes='m-2 bg-gray-100 border-2 border-gray-200 rounded w-64 focus:bg-white'
                                     'focus:outline-none focus:border-purple-700 py-2 px-4')
